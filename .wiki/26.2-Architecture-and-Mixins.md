# 🏛️ Technical Architecture & Mixin Engine (MC 26.2)
...
| **Mod ID** | `velocity-render` |
| **Root Package** | `net.vanillaoutsider.velocityrender` |
| **Client Mixin Class** | `net.vanillaoutsider.velocityrender.client.mixin.SectionTaskDynamicQueueMixin` |
| **Target Minecraft Class** | `net.minecraft.client.renderer.chunk.SectionTaskDynamicQueue` |
| **Mixin Configuration** | `velocity-render.mixins.json` |
...
+------------------------------------+        +-----------------------------------+
| net.vanillaoutsider.velocityrender.    |        | net.vanillaoutsider.velocityrender.   |
|   client                           |        |   server                          |
|                                    |        |                                   |
| +--------------------------------+ |        | +-------------------------------+ |
...
+------------------------------------+        | - TicketType.PLAYER_LOADING       |
                  ...
                  v
+------------------------------------+
| net.vanillaoutsider.velocityrender.    |
|   math                             |
|                                    |
| +--------------------------------+ |
...
```json
{
  ...
  "contact": {
    "homepage": "https://modrinth.com/mod/velocity-render",
    "sources": "https://github.com/Rifaditya/Vanilla-Outsider-Velocity-Render",
    "issues": "https://github.com/Rifaditya/Vanilla-Outsider-Velocity-Render/issues"
  },
  "license": "GPL-3.0-only",
  "icon": "assets/velocity-render/icon.png",
  "environment": "*",
  "entrypoints": {
    "main": [
      "net.vanillaoutsider.velocityrender.YouRunFastMod"
    ],
    "client": [
      "net.vanillaoutsider.velocityrender.client.YouRunFastClient"
    ]
  },
  "mixins": [
    "velocity-render.mixins.json"
...
| :--- | :--- | :--- |
| **Mixin Class** | `net.vanillaoutsider.velocityrender.client.mixin.SectionTaskDynamicQueueMixin` | Isolated client-side injection |
