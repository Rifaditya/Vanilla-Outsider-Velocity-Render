# 🌐 Server-Side Predictive Chunk Generation & Ticket Cones (MC 26.2)
...
| **Controlling GameRules** | `velocityrender:enabled`, `velocityrender:budget_conservation`, `velocityrender:forward_lead_multiplier` |
