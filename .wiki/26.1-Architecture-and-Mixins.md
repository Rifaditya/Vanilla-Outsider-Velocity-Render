...
| **Client Mixin Class** | `net.vanillaoutsider.velocityrender.client.mixin.CompileTaskDynamicQueueMixin` |
...
| :--- | :--- | :--- |
| **Mixin Class** | `net.vanillaoutsider.velocityrender.client.mixin.CompileTaskDynamicQueueMixin` | Isolated client-side injection |
