# 🖥️ Client-Side Anisotropic Chunk Mesh Prioritization (MC 26.1)
...
| **Client Polling Mixin** | `net.vanillaoutsider.velocityrender.client.mixin.CompileTaskDynamicQueueMixin` |
| **Vanilla Target Class** | `net.minecraft.client.renderer.chunk.CompileTaskDynamicQueue` |
| **Target Method** | `poll()` |
...
```java
// Target Class: CompileTaskDynamicQueue
